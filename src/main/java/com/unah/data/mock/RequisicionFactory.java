...
public class RequisicionFactory {
    ...
    public static List<RequisicionMock> load(){
        ...
        data.add(new RequisicionMock("2", "Bar / 29-07-2020 / 11:41:41", "Entregada", "Bar", "Edgardo", true, "Mario", new Date(2020,7,28), prods));
        data.add(new RequisicionMock("3", "Cocina / 30-07-2020 / 11:41:41", "Entregada", "Cocina", "Boris", true, "Edgardo", new Date(2020,7,29), prods));
