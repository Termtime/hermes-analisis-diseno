...
public class MantUsuariosModalModificarUsuario implements Initializable {
        ...
        if (!areasSeleccionadas.isEmpty()) {
            if (txtNombre.getText().trim() != null) {
                ...
                if (!txtContrasena.getText().trim().isEmpty() && txtContrasena.getText().trim().length() >= 6
                        && checkCambiarContra.isSelected()) {
                    db.cambiarPassword(usuarioDatos.uid, txtContrasena.getText().trim());
                }

                Navigation.mostrarAlertExito("Usuario modificado correctamente.", event);
                cerrarVentana();
            }
    ...
    @FXML
    private void comboNivelAccesoClick(ActionEvent event) {
    ...
    @FXML
    private void checkCambiarContraClick(ActionEvent event) {
    ...
    Button btnCancelar;
    @FXML
    Pane panelJefeUsuario;
    @FXML
    AnchorPane mantUsuariosModalAgregarUsuario;
    @FXML
    ListView<Area> listAreas;
    @FXML
    TextField txtNombre;
    @FXML
    ComboBox<String> comboNivelAcceso;
    @FXML
    ...
    @FXML
    Button btnQuitarArea;
    @FXML
    Label labelAreasSeleccionada;
    @FXML
    Label labelAreas;
    @FXML
    ...
    Rectangle marco;
    @FXML
    AnchorPane mantUsuariosModalModificarUsuario;
    @FXML
    Label errorPass;
    @FXML
    CheckBox checkCambiarContra;
    ...
    private void llenarCombo() {
        ...
        // para la ventana de modificar, para llenar la lista de la derecha y la
        // izquierda
        for (Area area : areas) {
